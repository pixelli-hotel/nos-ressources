...
class Namechange
{
    ...
    {
        $namechange = filter_input(INPUT_GET, "namechange", FILTER_SANITIZE_FULL_SPECIAL_CHARS);
        ...
        Player::update(request()->player->id, ['changeusername' => $namechange]);
        ...
        response()->json(["status" => "success", "message" => LocaleService::get('settings/email_saved'), "replacepage" => "/client"]);
